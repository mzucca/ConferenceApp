    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, 1, new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6966), 5.0, 0, "SALE", new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6966), new DateTime(2024, 6, 14, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6969) },
                    { 2, null, 0, new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6974), 1.0, 1, "FIX", new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6974), new DateTime(2024, 6, 14, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6975) }
                });

            migrationBuilder.InsertData(
                table: "lesson_packages",
                columns: new[] { "Id", "cost", "created_at", "lessons_num", "name", "updated_at" },
                values: new object[,]
                {
                    { 1, 9.9000000000000004, new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6933), 1, "PACKAGE NAME N.001", new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6933) },
                    { 2, 44.899999999999999, new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6936), 5, "PACKAGE NAME N.002", new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6936) },
                    { 3, 79.900000000000006, new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6937), 10, "PACKAGE NAME N.003", new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6937) }
                });

            migrationBuilder.InsertData(
                table: "users",
                columns: new[] { "Id", "AvatarUrl", "created_at", "Deleted", "Email", "Gender", "IsVerified", "Name", "Password", "Surname", "Type", "updated_at" },
                values: new object[,]
                {
                    { 1, "test", new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6612), false, "9iYms6TCxuISbWFyaW96NjNAZ21haWwuY29t", 0, true, "Mario", "9iYms6TCxuIJMTIzNDU2Nzg5", "Z.", 0, new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6613) },
                    { 2, "https://static.wikia.nocookie.net/rickandmorty/images/3/3f/Young_Adult_Rick.png", new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6804), false, "9iYms6TCxuITZG9jdG9yMUBleGFtcGxlLmNvbQ==", 0, true, "Rick", "9iYms6TCxuIJMTIzNDU2Nzg5", "Sanchez", 1, new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6805) },
                    { 3, "https://static.wikia.nocookie.net/marveldatabase/images/0/02/Adam_Warlock_%28Earth-829%29_from_Hercules_Vol_2_3_0001.jpg", new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6809), false, "9iYms6TCxuITZG9jdG9yMkBleGFtcGxlLmNvbQ==", 0, false, "Adam", "9iYms6TCxuIJMTIzNDU2Nzg5", "Warlock", 1, new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6809) },
                    { 4, null, new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6834), false, "9iYms6TCxuIRdGVzdDFAZXhhbXBsZS5jb20=", 3, false, "Test01", "9iYms6TCxuIJMTIzNDU2Nzg5", "Test01", 0, new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6835) },
                    { 5, null, new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6899), false, "9iYms6TCxuIRdGVzdDJAZXhhbXBsZS5jb20=", 3, false, "Test02", "9iYms6TCxuIJMTIzNDU2Nzg5", "Test02", 0, new DateTime(2024, 5, 15, 8, 6, 31, 16, DateTimeKind.Utc).AddTicks(6899) }
                });
