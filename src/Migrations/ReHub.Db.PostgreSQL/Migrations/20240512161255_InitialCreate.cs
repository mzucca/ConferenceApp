...
namespace ReHub.Db.PostgreSQL.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 5.0, 0, "SALE", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 6, 11, 16, 12, 54, 589, DateTimeKind.Utc).AddTicks(6277) },
                    { 2, null, 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1.0, 1, "FIX", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 6, 11, 16, 12, 54, 589, DateTimeKind.Utc).AddTicks(6285) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "test", new DateTime(2024, 5, 12, 16, 12, 54, 589, DateTimeKind.Utc).AddTicks(5825), false, "nOi/SI37w5ARbWF6aW96NjNAbWFpbC5jb20=", 0, true, "Mario", "UuxhwrviQOIJMTIzNDU2Nzg5", "Z.", 1, new DateTime(2024, 5, 12, 16, 12, 54, 589, DateTimeKind.Utc).AddTicks(5826) },
                    { 2, "https://static.wikia.nocookie.net/rickandmorty/images/3/3f/Young_Adult_Rick.png", new DateTime(2024, 5, 12, 16, 12, 54, 589, DateTimeKind.Utc).AddTicks(6131), false, "3CLuM1X6+fATZG9jdG9yMUBleGFtcGxlLmNvbQ==", 0, true, "Rick", "2G2yGg3HBx8JMTIzNDU2Nzg5", "Sanchez", 1, new DateTime(2024, 5, 12, 16, 12, 54, 589, DateTimeKind.Utc).AddTicks(6132) },
                    { 3, "https://static.wikia.nocookie.net/marveldatabase/images/0/02/Adam_Warlock_%28Earth-829%29_from_Hercules_Vol_2_3_0001.jpg", new DateTime(2024, 5, 12, 16, 12, 54, 589, DateTimeKind.Utc).AddTicks(6138), false, "nW/pVeBbqeoTZG9jdG9yMkBleGFtcGxlLmNvbQ==", 0, false, "Adam", "Y4BfgqUahS0JMTIzNDU2Nzg5", "Warlock", 1, new DateTime(2024, 5, 12, 16, 12, 54, 589, DateTimeKind.Utc).AddTicks(6139) },
                    { 4, null, new DateTime(2024, 5, 12, 16, 12, 54, 589, DateTimeKind.Utc).AddTicks(6182), false, "yXoPeJEQiVgRdGVzdDFAZXhhbXBsZS5jb20=", 3, false, "Test01", "G4phecNEEOoJMTIzNDU2Nzg5", "Test01", 0, new DateTime(2024, 5, 12, 16, 12, 54, 589, DateTimeKind.Utc).AddTicks(6183) },
                    { 5, null, new DateTime(2024, 5, 12, 16, 12, 54, 589, DateTimeKind.Utc).AddTicks(6187), false, "wGgS22mYeq4RdGVzdDJAZXhhbXBsZS5jb20=", 3, false, "Test02", "Obrk9FW0FY0JMTIzNDU2Nzg5", "Test02", 0, new DateTime(2024, 5, 12, 16, 12, 54, 589, DateTimeKind.Utc).AddTicks(6187) }
                });
