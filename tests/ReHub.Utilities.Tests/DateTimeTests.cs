...
namespace ReHub.Utilities.Tests
{
    public class DateTimeTests
    {
        ...
        public void AddFluentTimeSpan()
        {
            ...
            Xunit.Assert.Equal(new(1976, 2, 1, 0, 0, 0, DateTimeKind.Local), originalPointInTime.AddFluentTimeSpan(fluentTimeSpan));
        }
        ...
        public void SubtractFluentTimeSpan()
        {
            ...
            var fluentTimeSpan = 1.Months();
            Xunit.Assert.Equal(new(1976, 1, 1, 0, 0, 0, DateTimeKind.Local), originalPointInTime.SubtractFluentTimeSpan(fluentTimeSpan));
        }
        ...
        public void ChangeTime_Hour_SimpleTests_Arg_Checks(int value)
        {
            ...
            Xunit.Assert.Throws<ArgumentOutOfRangeException>(() => { toChange.SetTime(value); });
        }
        ...
        {
            var toChange = new DateTime(2008, 10, 25, 0, 0, 0, 0, DateTimeKind.Local);
            Xunit.Assert.Throws<ArgumentOutOfRangeException>(() => { toChange.SetTime(0, value); });
        }
        ...
        public void ChangeTime_Second_SimpleTests_Arg_Checks(int value)
        {
            ...
            Xunit.Assert.Throws<ArgumentOutOfRangeException>(() => { toChange.SetTime(0, 0, value); });
        }
        ...
        {
            var toChange = new DateTime(2008, 10, 25, 0, 0, 0, 0, DateTimeKind.Local);
            Xunit.Assert.Throws<ArgumentOutOfRangeException>(() => { toChange.SetTime(0, 0, 0, value); });
        }
        ...
        public void BasicTests()
        {
            ...
            Xunit.Assert.Equal(new(2009, 1, 1, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2008, 12, 31, 0, 0, 0, DateTimeKind.Local).Add(1.Days()));
            Xunit.Assert.Equal(new(2009, 1, 2, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2009, 1, 1, 0, 0, 0, 0, DateTimeKind.Local).Add(1.Days()));
        ...
        public void IsBefore_ReturnsTrueForGivenDateThatIsInTheFuture()
        {
            ...
            // Xunit.Assert
            Xunit.Assert.True(DateTime.Today.IsBefore(toCompareWith));
        }
        ...
        public void IsAfter_ReturnsTrueForGivenDateThatIsInThePast()
        {
            ...
            // Xunit.Assert
            Xunit.Assert.True(DateTime.Today.IsAfter(toCompareWith));
        }
        ...
        public void FirstDayOfYear_BasicTest(string value) =>
            Xunit.Assert.Equal(new(2011, 1, 1, 6, 40, 20, 5), DateTime.Parse(value).FirstDayOfYear());
        ...
        public void LastDayOfWeek_BasicTest(string value)
        {
            ...
            Thread.CurrentThread.CurrentCulture = currentCulture;
            Xunit.Assert.Equal(new(2011, 12, 25, 06, 40, 20, 5), DateTime.Parse(value).LastDayOfWeek());
            Thread.CurrentThread.CurrentCulture = ci;
        }
        ...
        public void LastDayOfYear_BasicTest(string value) =>
            Xunit.Assert.Equal(new(2011, 12, 31, 06, 40, 20, 5), DateTime.Parse(value).LastDayOfYear());
        ...
        public void SameYear_Y(string dateValue)
        {
            ...
            Xunit.Assert.True(date.SameYear(other));
        }
        ...
        public void SameYear_N(string dateValue)
        {
            ...
            Xunit.Assert.False(date.SameYear(other));
        }
        ...
        public void SameMonth_Y(string dateValue)
        {
            ...
            Xunit.Assert.True(date.SameMonth(other));
        }
        ...
        public void SameMonth_N(string dateValue)
        {
            ...
            Xunit.Assert.False(date.SameMonth(other));
        }
        ...
        public void SameDay_Y(string dateValue)
        {
            ...
            Xunit.Assert.True(date.SameDay(other));
        }
        ...
        public void SameDay_N(string dateValue)
        {
            ...
            Xunit.Assert.False(date.SameDay(other));
        }
        ...
        public void BeginningOfWeekMonday_BasicTest(string value)
        {
            ...
            Thread.CurrentThread.CurrentCulture = currentCulture;
            Xunit.Assert.Equal(new(2011, 12, 19, 0, 0, 0, 0), DateTime.Parse(value).BeginningOfWeek());
            Thread.CurrentThread.CurrentCulture = ci;
        }
        ...
        public void EndOfWeekMonday_BasicTest(string value)
        {
            ...
            Thread.CurrentThread.CurrentCulture = currentCulture;
            Xunit.Assert.Equal(new(2011, 12, 25, 23, 59, 59, 999), DateTime.Parse(value).EndOfWeek());
            Thread.CurrentThread.CurrentCulture = ci;
        }
        ...
        public void BeginningOfWeekSunday_BasicTest(string value)
        {
            ...
            Thread.CurrentThread.CurrentCulture = currentCulture;
            Xunit.Assert.Equal(new(2011, 12, 18, 0, 0, 0, 0), DateTime.Parse(value).BeginningOfWeek());
            Thread.CurrentThread.CurrentCulture = ci;
        }
        ...
        public void EndOfWeekSunday_BasicTest(string value)
        {
            ...
            Thread.CurrentThread.CurrentCulture = currentCulture;
            Xunit.Assert.Equal(new(2011, 12, 24, 23, 59, 59, 999), DateTime.Parse(value).EndOfWeek());
            Thread.CurrentThread.CurrentCulture = ci;
        }
        ...
        public void BeginningOfMonth_BasicTest(string value)
        {
            ...
            Thread.CurrentThread.CurrentCulture = currentCulture;
            Xunit.Assert.Equal(new(2011, 12, 01, 0, 0, 0, 0), DateTime.Parse(value).BeginningOfMonth());
            Thread.CurrentThread.CurrentCulture = ci;
        }
        ...
        public void EndOfMonth_BasicTest(string value)
        {
            ...
            Thread.CurrentThread.CurrentCulture = currentCulture;
            Xunit.Assert.Equal(new(2011, 12, 31, 23, 59, 59, 999), DateTime.Parse(value).EndOfMonth());
            Thread.CurrentThread.CurrentCulture = ci;
        }
        ...
        public void BeginningOfQuarter_BasicTest(string value)
        {
            ...
            Thread.CurrentThread.CurrentCulture = currentCulture;
            Xunit.Assert.Equal(new(2011, 10, 01, 0, 0, 0, 0), DateTime.Parse(value).BeginningOfQuarter());
            Thread.CurrentThread.CurrentCulture = ci;
        }
        ...
        public void EndOfQuarter_BasicTest(string value)
        {
            ...
            Thread.CurrentThread.CurrentCulture = currentCulture;
            Xunit.Assert.Equal(new(2011, 12, 31, 23, 59, 59, 999), DateTime.Parse(value).EndOfQuarter());
            Thread.CurrentThread.CurrentCulture = ci;
        }
        ...
        public void BeginningOfYear_BasicTest(string value)
        {
            ...
            Thread.CurrentThread.CurrentCulture = currentCulture;
            Xunit.Assert.Equal(new(2011, 01, 01, 0, 0, 0, 0), DateTime.Parse(value).BeginningOfYear());
            Thread.CurrentThread.CurrentCulture = ci;
        }
        ...
        public void EndOfYear_BasicTest(string value)
        {
            ...
            Thread.CurrentThread.CurrentCulture = currentCulture;
            Xunit.Assert.Equal(new(2011, 12, 31, 23, 59, 59, 999), DateTime.Parse(value).EndOfYear());
            Thread.CurrentThread.CurrentCulture = ci;
        }
    }
}
